...
const androidLink = 'https://play.google.com/store/apps/details?id=com.hutbite.hutbite';
...
export const ShareButton: React.FC<ShareButtonProps> = ({
  ...
  const handlePress = async () => {
    const sharedMessage = menuItemTitle
      ? `Check out ${menuItemTitle} at ${restaurantName} on hutbite!`
      : `Check out ${restaurantName} on hutbite!`;
